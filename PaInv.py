...
#from transformers import dummy_tokenizers_objects as tokenizer
...
def perturb(sent, bertmodel, num):
    ...
    """
    sent="Three months later, Holmes was indicted on federal wire fraud charges and stepped down from mt."
